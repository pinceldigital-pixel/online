// --- CAMBIO: Actualizamos la versión del caché a v4 ---
...
// Esto se asegura de que la v1, v2 y v3 se eliminen
self.addEventListener('activate', event => {
  const cacheWhitelist = [CACHE_NAME]; // Solo queremos que exista el caché v4
  event.waitUntil(
