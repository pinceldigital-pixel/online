// --- CAMBIO: Actualizamos la versión del caché ---
...
// --- NUEVO: Limpieza de cachés viejos ---
// Esto se asegura de que la v1 se elimine
self.addEventListener('activate', event => {
  const cacheWhitelist = [CACHE_NAME]; // Solo queremos que exista el caché v2
  event.waitUntil(
